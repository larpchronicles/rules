...
If a caster's spell incant or throw is disrupted, the Mana Points (or ability) used to cast the spell are lost the same as though it were successfully cast.  Taking damage does not interrrupt a cast, however, effects that would prevent spellcasting (such as Stun, or being dead) can interrupt the casting of a spell. 
