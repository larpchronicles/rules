...
| OVERWHELMING STRENGTH| Character swings for Vital damage. Damage from user is always taken unless target makes a defensive call.| N/A | No |
...
| RIFT | Character teleports to a location specified by the caster. User must have been physically present in the location previously. User must move directly to their destination and Rift In immediately upon arrival. |1 I Rift, 2... 3...|Yes |
