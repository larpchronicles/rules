...
---
Sources of the effects below include Skills, Abilities, Spells, and Production items.
...
| LIFE | DEAD target is returned to life with 1 Body. | Varies by source. |
...
| SOLIDIFY | Forces a GASEOUS target to lose their gaseous effect on a 3 count. | Varies by source. |
| SPELLSTRIKE | Character may deliver a spell with a physical weapon. |Spellstrike (Spell Name) |
