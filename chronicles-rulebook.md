...
- [New Player Guide][#new-player-guide]
    - [Hello (potentially) New Player!][#hello-potentially-new-player-]
    - [Getting Started][#getting-started]
        - [Character Creation][#character-creation]
            - [Character Considerations:][#character-considerations-]
            - [Mechanically Building a Character:][#mechanically-building-a-character-]
        - [Skill Point Gain:][#skill-point-gain-]
        - [Reallocating Skill Points][#reallocating-skill-points]
        - [Quick Reference of Common Terms][#quick-reference-of-common-terms]
    - [How Does Combat Work?][#how-does-combat-work-]
        - [How To Regain Expended Skills and Abilities][#how-to-regain-expended-skills-and-abilities]
        - [What To Bring To a First Event][#what-to-bring-to-a-first-event]
    - [What to Expect at an Event][#what-to-expect-at-an-event]
        - [Typical progression for a two-day event:][#typical-progression-for-a-two-day-event-]
...
- [Who You Will Encounter:  Staff, Players, Trust][#who-you-will-encounter-staff-players-trust]
    - [Plot Members and Marshals][#plot-members-and-marshals]
        - [How to Become A Ritual Marshal][#how-to-become-a-ritual-marshal]
    - [Expectations of Participants][#expectations-of-participants]
        - [General Etiquette][#general-etiquette]
        - [Hold &amp; Medic Calls][#hold-medic-calls]
        - [In Game vs. Out of Game Areas &amp; Combat][#in-game-vs-out-of-game-areas-combat]
            - [No-Combat Areas][#no-combat-areas]
- [Storytelling &amp; Goals][#storytelling-goals]
    - [Adventures (Formerly Mods)][#adventures-formerly-mods-]
    - [Town Encounters (Formerly Town Mods)][#town-encounters-formerly-town-mods-]
    - [Storyline][#storyline]
    - [Goals (capital G)][#goals-capital-g-]
- [Check In, Check Out, and Event Site Information][#check-in-check-out-and-event-site-information]
    - [Check In Procedure][#check-in-procedure]
    - [Check Out Procedure][#check-out-procedure]
    - [Event Fees &amp; Meal Tickets][#event-fees-meal-tickets]
        - [Tavern &amp; Meal Tickets][#tavern-meal-tickets]
    - [Camp Site Rules During Check In][#camp-site-rules-during-check-in]
        - [Camp Eastman][#camp-eastman]
        - [Camp Illinek][#camp-illinek]
    - [Cabins][#cabins]
        - [Camp Eastman][#camp-eastman]
        - [Camp Illinek][#camp-illinek]
- [Equipment][#equipment]
    - [Weapon Construction][#weapon-construction]
    - [Weapon Crafting Materials][#weapon-crafting-materials]
    - [Weapon Crafters][#weapon-crafters]
- [Garb][#garb]
- [NPC-Garb][#npc-garb]
- [Melee Weapons][#melee-weapons]
        - [Striking Surface][#striking-surface]
        - [Handle Length][#handle-length]
        - [Weapon Heads][#weapon-heads]
- [Ranged Weapons][#ranged-weapons]
        - [Bows][#bows]
        - [Crossbows][#crossbows]
- [Shields][#shields]
    - [Shield Construction][#shield-construction]
    - [Shield Crafting Materials][#shield-crafting-materials]
- [Armor][#armor]
    - [Armor and Combat][#armor-and-combat]
    - [Armor Point Calculations][#armor-point-calculations]
    - [Armor Types][#armor-types]
        - [Light Armor][#light-armor]
            - [Cloth][#cloth]
        - [Medium Armor][#medium-armor]
            - [Hardened Leather][#hardened-leather]
            - [Chain/Composite][#chain-composite]
        - [Heavy Armor][#heavy-armor]
            - [Plate][#plate]
    - [Armor Locations][#armor-locations]
        - [Helmets][#helmets]
        - [Armor Example][#armor-example]
- [Spell / Arrow / Alchemy Packets][#spell-arrow-alchemy-packets]
        - [Packet Crafting Materials][#packet-crafting-materials]
- [Combat Rules][#combat-rules]
    - [Armor: Immunities][#armor-immunities]
    - [Armor: Receiving Damage][#armor-receiving-damage]
    - [Bows and Crossbows: Blocking][#bows-and-crossbows-blocking]
    - [Casting Spells][#casting-spells]
    - [Ability Verbals and Damage Calls][#ability-verbals-and-damage-calls]
        ...
        - [Damage Calls][#damage-calls]
            ...
            - [Carriers][#carriers]
            - [Damage Call Examples][#damage-call-examples]
    - [Defense Slots][#defense-slots]
        - [Healed By [Effect]][#healed-by-effect-]
        - [Immunities][#immunities]
    - [Killing Blows][#killing-blows]
    - [Magic Deliverance, Voice Radius, and Aether][#magic-deliverance-voice-radius-and-aether]
    - [Physical Strikes][#physical-strikes]
    - [Shields][#shields]
    - [Spell Packets][#spell-packets]
        - [Spellstrikes][#spellstrikes]
        - [Touch-Casting][#touch-casting]
- [Combat Etiquette][#combat-etiquette]
    - [Players Not Observing Etiquette][#players-not-observing-etiquette]
    - [Light Touch][#light-touch]
    - [Strike Zones][#strike-zones]
    - [Speed of Combat][#speed-of-combat]
    - [Charging][#charging]
    - [Fighting in Tight Settings][#fighting-in-tight-settings]
    - [Trapping][#trapping]
    - [Turtling][#turtling]
    - [Weapon on Weapon][#weapon-on-weapon]
    - [Weapon Safety Checks][#weapon-safety-checks]
    - [Headbands][#headbands]
        - [Orange Headbands - Non Combatants &amp; Pages][#orange-headbands-non-combatants-pages]
        - [White Headbands - Out of Game][#white-headbands-out-of-game]
    - [Communication is Your Greatest Weapon][#communication-is-your-greatest-weapon]
    - [&quot;Lay on!&quot;][#lay-on-]
    - [Hold!][#hold-]
    - [Medic v Healer][#medic-v-healer]
- [Life &amp; Death][#life-death]
    - [Body <em>(aka Health Points)</em>][#body-aka-health-points-]
    - [Alive][#alive]
    - [Unconscious][#unconscious]
    - [Bleeding Out (aka Dying)][#bleeding-out-aka-dying-]
    - [Dead][#dead]
    - [Spirits][#spirits]
    - [Resurrection][#resurrection]
    - [Skill Point Debt][#skill-point-debt]
        - [Post-Event SP Calculation][#post-event-sp-calculation]
            - [SP Debt Example][#sp-debt-example]
    - [Permanent Death][#permanent-death]
    - [Retiring a Character][#retiring-a-character]
    - [Killing Blow][#killing-blow]
    - [Dismemberment &amp; Body Smuggling][#dismemberment-body-smuggling]
    - [Metabolisms][#metabolisms]
        - [No Metabolism][#no-metabolism]
        - [Undead Metabolism][#undead-metabolism]
    - [Spirit Bottle][#spirit-bottle]
- [Combat Mechanics][#combat-mechanics]
    - [Melee Combat Mechanics][#melee-combat-mechanics]
    - [Ranged Combat Mechanics][#ranged-combat-mechanics]
    - [Caster Combat Mechanics][#caster-combat-mechanics]
    - [Health and Armor Mechanics][#health-and-armor-mechanics]
- [Races][#races]
    - [Brood][#brood]
    - [Dwarf][#dwarf]
    - [Elf][#elf]
...
- [Effects][#effects]
    ...
    - [Removing Effects][#removing-effects]
    - [Visible Effects][#visible-effects]
    - [Identifying Non-visible Effects][#identifying-non-visible-effects]
    - [Effect Clarifications][#effect-clarifications]
        - [Concentration][#concentration]
        - [Critical Ability][#critical-ability]
        - [Curse of Transformation][#curse-of-transformation]
        - [Entrapment Clarification][#entrapment-clarification]
        - [Shattering &amp; Destroying][#shattering-destroying]
        - [Skill-less Clarification][#skill-less-clarification]
    - [Ability][#ability]
    - [Effects][#effects]
    - [Status][#status]
    - [How to Diagnose][#how-to-diagnose]
- [Skillsets][#skillsets]
    - [Skillset Prioritization][#skillset-prioritization]
        - [Fighter Skillset][#fighter-skillset]
        - [Mage Skillset][#mage-skillset]
        - [Rogue Skillset][#rogue-skillset]
        - [General Skillset][#general-skillset]
- [Fighter Skillset][#fighter-skillset]
    - [One-Handed Proficiency][#one-handed-proficiency]
    - [Off-Handed Proficiency][#off-handed-proficiency]
    - [Ranged Proficiency][#ranged-proficiency]
    - [Two-Handed Proficiency][#two-handed-proficiency]
    - [Armor Training][#armor-training]
    - [Shield][#shield]
    - [Stamina Points][#stamina-points]
    - [Toughness][#toughness]
- [Mage Skillset][#mage-skillset]
    - [Primary Initiation][#primary-initiation]
    - [Secondary Initiation][#secondary-initiation]
    - [Tertiary Initiation][#tertiary-initiation]
    - [Attunement][#attunement]
    - [Blood Magic][#blood-magic]
    - [Exsanguinate][#exsanguinate]
- [Rogue Skillset][#rogue-skillset]
    - [Agility Points][#agility-points]
    - [Backstab][#backstab]
    - [Escape Artist][#escape-artist]
    - [Lockpicking][#lockpicking]
    - [Mimicry][#mimicry]
    - [Trapping][#trapping]
- [Stamina Abilities][#stamina-abilities]
    - [Stamina Abilities][#stamina-abilities]
- [Agility Skills][#agility-skills]
    - [Agility Point Skills][#agility-point-skills]
- [Universal Spells][#universal-spells]
- [Arcane Spells][#arcane-spells]
- [Nature Magic][#nature-magic]
- [Spirit Spells][#spirit-spells]
- [Ritual Magic][#ritual-magic]
    - [About Ritual Magic][#about-ritual-magic]
    - [Standard Library][#standard-library]
        - [Ritual Level I][#ritual-level-i]
            - [Elemental Shift][#elemental-shift]
            - [Create Spirit Familiar][#create-spirit-familiar]
        - [Ritual Level II][#ritual-level-ii]
            - [Dampen Magic][#dampen-magic]
        - [Ritual Level III][#ritual-level-iii]
            - [Race Change][#race-change]
            - [Purify/Corrupt The Land][#purify-corrupt-the-land]
        - [Ritual Level IV][#ritual-level-iv]
            - [Spirit Journey][#spirit-journey]
            - [Spirit Link][#spirit-link]
            - [Spirit Lock][#spirit-lock]
            - [Magical Barrier][#magical-barrier]
        - [Ritual Level V][#ritual-level-v]
            - [Spirit Forge][#spirit-forge]
        - [Ritual Level VI][#ritual-level-vi]
            - [?][#-]
        - [Ritual Level VIII][#ritual-level-viii]
            - [Destroy Ritual Magic][#destroy-ritual-magic]
        - [Ritual Level IX][#ritual-level-ix]
                 - [?][#-]
        - [Ritual Level X][#ritual-level-x]
            - [Empower Spirit][#empower-spirit]
    - [Uncommon Rituals][#uncommon-rituals]
        - [Ritual Level I][#ritual-level-i]
            - [?][#-]
        - [Ritual Level II][#ritual-level-ii]
            - [?][#-]
        ...
        - [Ritual Level IV][#ritual-level-iv]
            - [?][#-]
        - [Ritual Level V][#ritual-level-v]
            - [Spirit Familiar Transformation][#spirit-familiar-transformation]
        - [Ritual Level VI][#ritual-level-vi]
            - [Summon Entity][#summon-entity]
        - [Ritual Level VII][#ritual-level-vii]
            - [?][#-]
        - [Ritual Level VIII][#ritual-level-viii]
            - [?][#-]
        - [Ritual Level IX][#ritual-level-ix]
        ...
        - [Variable Level][#variable-level]
            - [Curse of Transformation: \&lt;Creature>][#curse-of-transformation-creature-]
- [Resting][#resting]
    - [Resetting Skills and Magic Items][#resetting-skills-and-magic-items]
    - [Rest][#rest]
    - [Per Day][#per-day]
- [Inventory: Coins, Tags, and Loot][#inventory-coins-tags-and-loot]
    - [Looting][#looting]
    - [Loot][#loot]
    - [Money][#money]
    - [Tags][#tags]
...
- [General Skills][#general-skills]
    - [Additional Defense Slot][#additional-defense-slot]
    - [Dexterity Armor][#dexterity-armor]
    - [First Aid][#first-aid]
    - [Identify][#identify]
    ...
    - [Tap Reserves][#tap-reserves]
    - [Tracking][#tracking]
    - [Foraging][#foraging]
    - [Logging][#logging]
    - [Mining][#mining]
    - [Alchemy][#alchemy]
    - [Rune Carving][#rune-carving]
    - [Smithing][#smithing]
    - [Artificing][#artificing]
    - [Recycling][#recycling]
- [Alchemy][#alchemy]
        - [Toxins][#toxins]
        - [Weapon Coatings][#weapon-coatings]
        - [Toxin Darts][#toxin-darts]
        - [Traps][#traps]
    - [Alchemy Products][#alchemy-products]
        - [Tier I][#tier-i]
            - [Blinding Toxin][#blinding-toxin]
            - [Poison Damage Dart][#poison-damage-dart]
            - [Slowing Toxin][#slowing-toxin]
        - [Tier II][#tier-ii]
        ...
        - [Tier III][#tier-iii]
            - [C-1 Explosive][#c-1-explosive]
            - [Heal Wounds Potion][#heal-wounds-potion]
            - [Poison Damage Dart][#poison-damage-dart]
            - [Weakness Toxin][#weakness-toxin]
        - [Tier IV][#tier-iv]
            - [Alchemical Adhesive][#alchemical-adhesive]
            - [Kneel Toxin][#kneel-toxin]
            - [Silver Dart][#silver-dart]
        - [Tier V][#tier-v]
            - [Oil of Silver][#oil-of-silver]
            - [Silencing Toxin][#silencing-toxin]
            - [Suppressing Oil][#suppressing-oil]
        - [Tier VI][#tier-vi]
            - [Cleansing Draught][#cleansing-draught]
            - [Heal Wounds Toxin][#heal-wounds-toxin]
            - [Sleep Toxin][#sleep-toxin]
        - [Tier VII][#tier-vii]
            - [C-2 Explosive][#c-2-explosive]
            - [Cursing Toxin][#cursing-toxin]
            - [Entangling Dart][#entangling-dart]
        - [Tier VIII][#tier-viii]
            - [Incredible Disappearing Ink][#incredible-disappearing-ink]
            - [Minimize Potion][#minimize-potion]
            - [Stunning Toxin][#stunning-toxin]
        - [Tier IX][#tier-ix]
            - [Confining Dart][#confining-dart]
            - [Gaseous Concoction][#gaseous-concoction]
            - [Reviving Draught][#reviving-draught]
        - [Tier X][#tier-x]
            - [Elixir of Energy][#elixir-of-energy]
            - [Elixir of Invulnerability][#elixir-of-invulnerability]
            - [Elixir of Venom Spitting][#elixir-of-venom-spitting]
- [Smithing][#smithing]
    - [Smithing Products][#smithing-products]
        - [Tier I][#tier-i]
            - [Alarm Trap][#alarm-trap]
            - [Key][#key]
            - [Lock][#lock]
            - [Rusty Weapon][#rusty-weapon]
        - [Tier II][#tier-ii]
            - [Armor Resizing Kit][#armor-resizing-kit]
            - [Lockpicks][#lockpicks]
            - [Suit of Armor][#suit-of-armor]
        - [Tier III][#tier-iii]
            - [Hardening][#hardening]
            - [Knight-Night Helmet][#knight-night-helmet]
            - [Repair Lock][#repair-lock]
        - [Tier IV][#tier-iv]
            - [Lock Hardening][#lock-hardening]
            - [One-Handed Weapon][#one-handed-weapon]
            - [Shield][#shield]
        - [Tier V][#tier-v]
            - [Silver Weapon Forging][#silver-weapon-forging]
            - [Two-Handed Weapon][#two-handed-weapon]
            - [Whetstone][#whetstone]
        - [Tier VI][#tier-vi]
            - [Golem Repair Kit][#golem-repair-kit]
            - [Pick Pocket Tools][#pick-pocket-tools]
            - [Ranged Weapon][#ranged-weapon]
        - [Tier VII][#tier-vii]
            - [Resistant Plating][#resistant-plating]
            - [Reinforcement Kit][#reinforcement-kit]
            - [Weighted Ammunition][#weighted-ammunition]
        - [Tier VIII][#tier-viii]
            - [Expandable Weapon][#expandable-weapon]
            - [Recycling Kit][#recycling-kit]
            - [Trickle Blade Modification][#trickle-blade-modification]
        - [Tier IX][#tier-ix]
            - [Armor Repair Kit][#armor-repair-kit]
            - [Forgemaster&#39;s Hammer][#forgemaster-s-hammer]
            - [Risky Smithing][#risky-smithing]
        - [Tier X][#tier-x]
            - [Masterwork Armor][#masterwork-armor]
            - [Masterwork Shield][#masterwork-shield]
            - [Masterwork Weapon][#masterwork-weapon]
- [Rune Carving][#rune-carving]
    - [Rune Carving Products][#rune-carving-products]
        - [Tier I][#tier-i]
            - [Glowing Wand Stone][#glowing-wand-stone]
            - [Rune of Trap Compression][#rune-of-trap-compression]
            - [Wand of Agility][#wand-of-agility]
            - [Wand of Magic][#wand-of-magic]
            - [Wand of Stamina][#wand-of-stamina]
        - [Tier II][#tier-ii]
            - [Rune of Imbuing][#rune-of-imbuing]
            - [Rune of Marking/Unmarking][#rune-of-marking-unmarking]
            - [Runic Rebreather][#runic-rebreather]
        - [Tier III][#tier-iii]
            - [Environmental Adaptation Rune][#environmental-adaptation-rune]
            - [Rune of the Beacon][#rune-of-the-beacon]
            - [Rune of Obscuring][#rune-of-obscuring]
        - [Tier IV][#tier-iv]
            - [Lock Corroding Rune][#lock-corroding-rune]
            - [Lock Enhancing Rune][#lock-enhancing-rune]
            - [Rune of Magic Deliverance][#rune-of-magic-deliverance]
        - [Tier V][#tier-v]
            - [Elemental Blade Rune][#elemental-blade-rune]
            - [Rune of Chambering][#rune-of-chambering]
            - [Rune of Limited Elemental Shift][#rune-of-limited-elemental-shift]
        - [Tier VI][#tier-vi]
        - [Rune of Spellstrike][#rune-of-spellstrike]
        - [Rune of True Death][#rune-of-true-death]
            - [Thiefbane Rune][#thiefbane-rune]
        - [Tier VII][#tier-vii]
            - [Rune of Elemental Barrier][#rune-of-elemental-barrier]
        - [Tier VIII][#tier-viii]
            - [Elemental Channeling Rune][#elemental-channeling-rune]
            - [Glyph of Haven][#glyph-of-haven]
            - [Rune of Mystic Lock][#rune-of-mystic-lock]
        - [Tier IX][#tier-ix]
            - [Rune of Greater Bag of Holding][#rune-of-greater-bag-of-holding]
            - [Rune of Recall][#rune-of-recall]
            - [Vengeance Rune][#vengeance-rune]
        - [Tier X][#tier-x]
            - [Break Enslavement Rune][#break-enslavement-rune]
            - [Glyph of Anchoring][#glyph-of-anchoring]
            - [Glyph of Warding][#glyph-of-warding]
            - [Rune of Glyph Removal][#rune-of-glyph-removal]
- [Artificing][#artificing]
    - [Artificing][#artificing]
    - [Attuning Enchanted Items][#attuning-enchanted-items]
    - [Artificing Products][#artificing-products]
    - [Standard Library][#standard-library]
        - [Tier I][#tier-i]
            - [Elemental Aura Enchantment][#elemental-aura-enchantment]
            - [Hearthstone][#hearthstone]
            - [Sticky Handle Enchantment][#sticky-handle-enchantment]
            - [Wand-in-the-Box Trap][#wand-in-the-box-trap]
        - [Tier II][#tier-ii]
            - [Deep Breath Balm][#deep-breath-balm]
            - [Destruction Magnet Enchantment][#destruction-magnet-enchantment]
            - [Magic Aura Enchantment][#magic-aura-enchantment]
        - [Tier III][#tier-iii]
            - [Mending Mallet][#mending-mallet]
            - [Sure Striking Enchantment][#sure-striking-enchantment]
        - [Tier IV][#tier-iv]
            - [Bracers of the Seasons][#bracers-of-the-seasons]
        - [Tier V][#tier-v]
            - [Elemental Resilience Enchantment][#elemental-resilience-enchantment]
        - [Tier VI][#tier-vi]
            - [Manaward Enchantment][#manaward-enchantment]
            - [Omni-Elemental Aura Enchantment][#omni-elemental-aura-enchantment]
        - [Tier VII][#tier-vii]
            - [Blade of Beginner&#39;s Luck][#blade-of-beginner-s-luck]
            - [Staunching Enchantment][#staunching-enchantment]
        - [Tier VIII][#tier-viii]
            - [Adaptive Armor Enchantment][#adaptive-armor-enchantment]
            - [Warding Shield Enchantment][#warding-shield-enchantment]
        - [Tier IX][#tier-ix]
            - [Energy Efficiency Enchantment][#energy-efficiency-enchantment]
            - [The Librarian][#the-librarian]
        - [Tier X][#tier-x]
            - [Sacrificial Shield][#sacrificial-shield]
            - [Vessel of Salvation][#vessel-of-salvation]
    - [Uncommon Formulas][#uncommon-formulas]
        - [Tier I][#tier-i]
            - [Bloodhound&#39;s Nose Ring][#bloodhound-s-nose-ring]
        - [Tier II][#tier-ii]
            - [?][#-]
        - [Tier III][#tier-iii]
            - [?][#-]
        - [Tier IV][#tier-iv]
            - [?][#-]
        - [Tier V][#tier-v]
            - [Globe of Radiance][#globe-of-radiance]
        - [Tier VI][#tier-vi]
            - [Sharpened Wit][#sharpened-wit]
        - [Tier VII][#tier-vii]
            - [Turtle&#39;s Torc][#turtle-s-torc]
        - [Tier VIII][#tier-viii]
            - [Alphastrike Potion][#alphastrike-potion]
        - [Tier IX][#tier-ix]
            - [Shield of the Last Stand][#shield-of-the-last-stand]
        - [Tier X][#tier-x]
            - [Mage&#39;s Folly][#mage-s-folly]
    - [Production Item Reference Table][#production-item-reference-table]
- [Knowledge Skills][#knowledge-skills]
    - [Arcane Knowledge][#arcane-knowledge]
    - [Criminal Knowledge][#criminal-knowledge]
    - [Economic Knowledge][#economic-knowledge]
    ...
    - [Spirit Knowledge][#spirit-knowledge]
    - [Survivalist Knowledge][#survivalist-knowledge]
    - [Theology Knowledge][#theology-knowledge]
- [Character Creation Process][#character-creation-process]
    - [First Topic][#first-topic]
- [Transformation][#transformation]
- [Transform Ability Rituals][#transform-ability-rituals]
    - [Ritual Tiers][#ritual-tiers]
    - [Transform Abilities][#transform-abilities]
        - [Unlocking Transform Abilities][#unlocking-transform-abilities]
            - [Unlock Transform Abilities Ritual Scroll][#unlock-transform-abilities-ritual-scroll]
        - [Multi-Tier][#multi-tier]
            - [Magic &lt;Effect&gt;][#magic-effect]
            - [Physical &lt;Effect&gt;][#physical-effect]
            - [Physical Strike &lt;Effect&gt;][#physical-strike-effect]
            - [Spellstrike][#spellstrike]
            - [Toxin &lt;Effect&gt;][#toxin-effect]
        - [Basic - Tier I][#basic-tier-i]
            - [Claws][#claws]
        - [Advanced - Tier III][#advanced-tier-iii]
            - [Body][#body]
            - [Backstab Expert][#backstab-expert]
            - [Critical Strike Expert][#critical-strike-expert]
            - [Gaseous Form][#gaseous-form]
            - [Parry/Spell Parry][#parry-spell-parry]
            - [Resist Magic][#resist-magic]
            - [Resist Physical][#resist-physical]
            - [Resist Toxin][#resist-toxin]
            - [Resist &lt;Effect&gt;][#resist-effect]
        - [Expert - Tier V][#expert-tier-v]
            - [Ambidexterity][#ambidexterity]
            - [Dexterity Armor Expert][#dexterity-armor-expert]
            - [&lt;Elemental&gt; Striker][#elemental-striker]
            - [Magic Striker][#magic-striker]
                 - [Proficiency Expert][#proficiency-expert]
            - [Spirit Bottle][#spirit-bottle]
        - [Master - Tier VIII][#master-tier-viii]
            - [Bane the Dead][#bane-the-dead]
            - [Body Weaponry][#body-weaponry]
            - [Destroy Ritual Magic][#destroy-ritual-magic]
            - [Dodge Expert][#dodge-expert]
            - [Dull Pain][#dull-pain]
            - [&lt;Effect&gt; Carrier][#effect-carrier]
            - [Healed by &lt;Element&gt;][#healed-by-element]
            - [Reduced Damage][#reduced-damage]
            - [Slay Expert][#slay-expert]
        - [Grandmaster - Tier IX][#grandmaster-tier-ix]
            - [Magic Deliverance][#magic-deliverance]
            - [&lt;Effect&gt; Carrier][#effect-carrier]
            - [Immunity to &lt;Type&gt;][#immunity-to-type]
            - [Regeneration][#regeneration]
            - [Rift Self][#rift-self]
            - [Voice Control &lt;Entity&gt;][#voice-control-entity]
            - [Voice Radius Spell][#voice-radius-spell]
            - [Weapon Mastery][#weapon-mastery]
        - [Mythical - Tier X][#mythical-tier-x]
            - [Aether &lt;Effect&gt;][#aether-effect]
            - [&lt;Effect&gt; Carrier][#effect-carrier]
            - [Plot Ability (Active)][#plot-ability-active-]
            - [Plot Ability (Passive)][#plot-ability-passive-]
            - [Rift Group][#rift-group]
- [NPCs &amp; Benefits][#npcs-benefits]
    - [What is a NPC?][#what-is-a-npc-]
    - [What does a NPC do?][#what-does-a-npc-do-]
    - [NPC Shifts][#npc-shifts]
    - [Double-Hooking, the Plot Queue, and NPC Shifts][#double-hooking-the-plot-queue-and-npc-shifts]
    - [NPC Rewards][#npc-rewards]
        - [Part-Time NPC Rewards][#part-time-npc-rewards]
        - [Full-Time NPC Rewards][#full-time-npc-rewards]
        - [Guest Plot Rewards][#guest-plot-rewards]
    - [How Do I Claim Mystery Sacks?][#how-do-i-claim-mystery-sacks-]
- [Goblin Points][#goblin-points]
    - [Goblin Points - What Are They?][#goblin-points-what-are-they-]
    - [How Do I Get Goblin Points?][#how-do-i-get-goblin-points-]
    - [Getting the Most Out of Goblin Points][#getting-the-most-out-of-goblin-points]
    - [Donations of Time][#donations-of-time]
    - [Item Donations][#item-donations]
    - [What Can I Spend Goblin Points On?][#what-can-i-spend-goblin-points-on-]
            - [<strong>Purchase Options</strong>][#purchase-options]
- [Glossary][#glossary]
    - [Reference Charts][#reference-charts]
        - [Spells][#spells]
            - [Arcane Spells][#arcane-spells]
            - [Nature Spells][#nature-spells]
            - [Spirit Spells][#spirit-spells]
            - [Universal Spells][#universal-spells]
        - [Abilities][#abilities]
        ...
        - [Spell Incants][#spell-incants]
        - [Production Item Reference Table][#production-item-reference-table]
- [Standing Policies][#standing-policies]
    - [Transfer Policy][#transfer-policy]
        - [Character Conversion from Other LARP Systems][#character-conversion-from-other-larp-systems]
        - [Money, Gems &amp; Items][#money-gems-items]
        - [Goblin Points][#goblin-points]
    - [Code of Conduct &amp; Disciplinary Rules][#code-of-conduct-disciplinary-rules]
    - [COVID Precautions][#covid-precautions]
        - [Covid Tests][#covid-tests]
    - [Summer Armor &amp; Make-up Policy][#summer-armor-make-up-policy]
...
|:---|---|:---:|
| AETHER| Character's attacks cannot be blocked, resisted, or in any way defended against. | Aether X| No |
| AURA | Character may swing <x> as their damage type | Varies by source. | No |
| BREACH ARMOR | Character reduces target's armor pool to 0. | \<Type\> Breach Armor | No |
| CORROSIVE| Character causes all tagged items that make physical contact are destroyed (as per shatter/destroy) at the end of the encounter | OOC | No |
| CRITICAL X | The character gains the ability to swing X against a single target of their choice. | I Invoke Critical X | No |
| DAMAGE CAP X| Character is only hit for maximum of x damage. | Damage Cap or Cap X| No |
| DESTROY | Target is destroyed after x time.| Varies by source. |Yes |
| DOUBLE DAMAGE | Character does double damage for x type. | Harm Double | Not Applicable |
| ENDURE| At 59 seconds of BLEED OUT status, character is restored to 1 Body. Requires 1 minute of CONCENTRATION by character. | Endurance | Not Applicable |
| EXCEPTIONAL STRENGTH | Character gains +1 Damage for each level of Exceptional Strength. | None | No |
| GASEOUS | Character becomes gaseous and cannot be affected by anything except SOLIDIFY & Dispel Magic.|1 I go gaseous, 2... 3...|Yes |
| HEALED BY| Character is healed by x type/effect. |Appears to Heal Me |Yes |
| HIVE MIND| Character may hear Hive Mind communication. |Hive Mind <Phrase> | No |
...
| POSSESSION | Character goes OOC, but may voice control the target. Acts as per ENSLAVEMENT.| 1 I possess you, 2... 3...| No |
...
| REDUCE | Character takes half damage from x effect, rounded up.|Reduced| No |
| REGENERATE | Character with CONSCIOUS status restores full body after 1 minute of CONCENTRATION effect. | Regenerating / Regenerate Complete |Yes ||
...
| RIFT | Character teleports to a location specified by the caster. Character must have been physically present in the location previously. Character must move directly to their destination and Rift In immediately upon arrival. |1 I Rift, 2... 3...|Yes |
| RIP FREE | Character may escape ENTANGLE effects. | 1 I Rip free, 2.. 3.. | Not Applicable |
| SPIRIT BOTTLE | Character dissipates at 0 body instead of taking UNCONSCIOUS status and reforms at the location of their spirit bottle. Character incurs no SP Debt. Spirit bottle is destroyed after x uses. | N/A | No |
| SUICIDE | Allows creature to die and dissipate at will regardless of other status effects. | 1 I suicide, 2... 3... | Not Applicable |
| VOICE CONTROL | Target is compelled to follow any instructions given by character | Voice Control X | No |
| X TO HIT | Character is immune to all weapons except x type. | No Effect | No |**
...
| SPELL STRIKE | Character may deliver a spell with a physical weapon. |Spellstrike (Spell Name) |
...
| ENSLAVEMENT | Target is compelled to follow any instructions given by character. Target is not Aware they are Enslaved. | Varies by source. |
...
| INVULNERABLE| Character is immune to all spells, physical attacks, and toxin for x time. | Varies by source. |
...
| **Duration** | Instant |
| **Verbal** | "Surprise" |
| **Description** | This skill allows character to add +2 damage against a single target, but is only usable while behind the target. May be stacked up to +10 damage (2 Backstab uses). As per Critical Ability. The effect ends when the character completes a Rest, or invokes another Critical ability against any target. |
...
| **Description** | This skill allows the character to throw a single Physical Entangle Foot. |
...
| **Description** | Allows the character to throw a single Physical Kneel. |
...
| **Description** | Allows the character to throw a single Toxin Breach Armor, which immediately reduces the target's armor value to 0. |
...
| **Description** | This skill allows the character to use Ranged Weapon proficiencies with a One-Handed Weapon against a single target without needing to be behind the target. May not be used with Backstab, Waylay, or Murder. Acts as per Critical Ability., |
...
#### Elemental Shift
This ritual augments "Mana Bolt" for an arcane magic character at every level with one of either:
...
> 
### Toxin Darts
> Toxin Darts function similarly to their Ingestible Counterparts, except they have been processed into an aerosolized gas instead of a powder that must be consumed to take effect. When using a Toxin Dart, the character must throw a packet while declaring "Toxin (Effect)" of the type indicated on the item tag. This cannot be blocked by weapons or shields, much like a Spell Packet.
> 
### Traps
...
#### Minimize Potion
> This potion is designed to quicken the metabolism of a creature when their adrenaline is high. Upon consumption, the character gains a single use of Minimize. They may choose to save this effect until they are hit with an effect, but they may only have a single use of this potion active at a time. This lasts until Rest or until it is used. This may not be used to Minimize DEAD, UNCONSCIOUS, DYING, or any effect that lasts Until Removed.
#### Stunning Toxin
...
#### Hearthstone
   >This is a warm stone that when held during Rest, allows the wielder to regain 1 Body per minute.  This is a passive effect.  This item cannot heal the holder if the holder is Dying or Dead.<br/>
...
####  Mending Mallet
   >A special Smithing Hammer built for a Smith on the go, with armor to repair and heads to smash. Three times per day, a character may spend Stamina on Rapid Refit to refit the armor of another Individual, instead of themselves, by touching them by doing the usual 5 count and declaring "Rapid Refit". Only usable by an individual with Ranks in Smithing.<br/>
...
#### Bloodhound's Nose Ring
   >This specially crafted and treated ring is designed to enhance the character's natural sense of smell. Two times a Day, the character can invoke the power of the Bloodhound to increase their likelihood of succeeding in attempting to Track someone as the ring enhances their natural sense of smell. However, this ring would overpower those without a refined sense of scent, and as such it is only usable by Kindred.<br/>
